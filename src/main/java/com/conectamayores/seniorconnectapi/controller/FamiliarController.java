...
public class FamiliarController {
    ...
    public ResponseEntity<Familiar> createFamiliar(@RequestBody Familiar familiar) {
        ...
        return new ResponseEntity<Familiar>(familiar1, HttpStatus.CREATED);
    }

    @GetMapping("/familiares")
    public ResponseEntity<List<Familiar>> getAllFamiliar () throws Exception{
        List<Familiar> familiarList =familiarRepository.findAll();
        return new ResponseEntity<List<Familiar>>(familiarList, HttpStatus.OK);
    }
    ...
    public ResponseEntity <Familiar> updateFamiliar (@PathVariable("id") Integer id, @RequestBody Familiar familiar) {
        ...
        return new ResponseEntity<Familiar>(familiarRepository.save(familiar),HttpStatus.OK);
    }
